...
export const metadata: Metadata = {
  title: "WebAI - ChatGPT-Powered AI Website Builder",
  description: "Build beautiful, AI-powered websites with just conversation. WebAI uses ChatGPT to design, develop, and manage your entire web presence automatically.",
  keywords: "AI website builder, ChatGPT, automated web design, AI chatbot, website automation, no-code platform",
  metadataBase: new URL("https://webai.com"),
  alternates: {
    canonical: "https://webai.com"
  },
  openGraph: {
    title: "WebAI - ChatGPT-Powered AI Website Builder",
    description: "Build beautiful, AI-powered websites with just conversation. Let artificial intelligence handle your web presence.",
    siteName: "WebAI",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764872355885-tpfjubpu.jpg",
      alt: "WebAI - AI Website Builder Interface"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "WebAI - ChatGPT-Powered AI Website Builder",
    description: "Build beautiful, AI-powered websites with just conversation.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764872355885-tpfjubpu.jpg"]
  },
  robots: {
    index: true,
    follow: true
